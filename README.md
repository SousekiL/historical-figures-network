...
- **关系类型筛选**：7 类细类（師生 / 好友 / 家族 / 同僚 / 政敵 / 唱和 / 交往）聚合为 4 大类（文学交往 / 政治关系 / 私人关系 / 一般交往），可按大类任意组合开关，只显示所选类别的关系及其子网络
- **筛选后自动重排**：切换朝代 / 关系类型 / 搜索后，对当前子图重新跑力导向布局（d3-force），自动铺满画布呈现该子图的最佳排布；回到全量时恢复预计算 DrL 布局
